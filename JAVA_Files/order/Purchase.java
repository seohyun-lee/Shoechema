...
public class Purchase {
    ...
    public static void purchase(int shoesOptionId) {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            if (rsDelivery.next() && rsProduct.next()) { //상품, 유저 하나
                ...
                switch (choice) {
                    case 1:
                        Order.createOrder(shoesOptionId, address, price, "Credit Card");
                        break;
                    case 2:
                        Order.createOrder(shoesOptionId, address, price, "Bank Transfer");
                        break;
                    case 0:
